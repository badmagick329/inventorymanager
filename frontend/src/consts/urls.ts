...
export const NEXT_USERS_ME = '/fetch/users/me';
...
export const NEXT_FRICTION_EVENTS = '/fetch/feedback/friction-events';
...
export const APP_POSSIBLE_FRICTION = '/app/admin/possible-friction';
export const APP_ASSISTANT_ACTIVITY = '/app/admin/assistant-activity';
...
export const API_FRICTION_EVENTS = '/api/users/feedback/friction-events';
